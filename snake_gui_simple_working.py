# Trading Snake - Simple Working GUI Version
# Simplified tkinter implementation
...
class SimpleGUISnake:
    def __init__(self):
        ...
        self.grid_color = '#3a5a3a3'
        self.snake_color = '#4b8b2b'
        self.food_color_profit = '#4caf50'
        self.food_color_loss = '#e74c3c'
    ...
    def setup_ui(self):
        ...
        # Left side - Game area
        game_frame = Frame(main_frame, bg=self.grid_color)
        ...
        info_frame = Frame(main_frame, bg='#34495e', width=250)
        ...
        # Controls
        self.controls_label = Label(info_frame, text="控制: 方向键或WASD | 空格暂停 | ESC退出",
                                 font=('Arial', 10),
                                 bg='#34495e', fg='white').pack(pady=10)
        ...
        # Start button
        self.start_button = tk.Button(info_frame, text="🎮 开始游戏", font=('Arial', 14, 'bold'),
                                     bg='#4caf50', fg='white',
                                     command=self.start_game, width=15, height=2)
        self.start_button.pack(pady=10)
        
        # Status
        self.status_label = Label(info_frame, text="按'开始游戏'开始",
                               font=('Arial', 11),
                               bg='#34495e', fg='#81c784')
    ...
    def draw_game(self):
        ...
        for i, (x, y) in enumerate(self.snake):
            if i == 0:
                ...
                self.canvas.create_oval(
                    x + 5 + eye_size + 2, y + 5 + eye_size + 2,
                    x + self.cell_size - 5 - eye_size + 2, y + 5 + eye_size + 2,
                    fill='white'
                )
            else:
                # Snake body
    ...
    def update_display(self):
        ...
        self.stats_label.config(text=f"交易: {self.trade_count} | 胜率: {win_rate:.0f}% | 传送: {self.teleport_count}")
    ...
    def show_message(self, message):
        ...
        self.root.after(1500, lambda: self.status_label.config(text="按'继续游戏", fg='#81c784'))
    ...
    def pause_game(self):
        if self.game_running:
            ...
            self.root.after(1000, lambda: self.status_label.config(text="按'继续游戏", fg='#81c784'))
        else:
            self.game_running = True
